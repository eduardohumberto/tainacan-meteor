import './selectboxInput.html';

Template.selectboxInput.onCreated(function () {
...
Template.selectboxInput.helpers({
    getValue:function(){
...
Template.selectboxInput.events({
  'change .js-save-property': function( event, template ) {
